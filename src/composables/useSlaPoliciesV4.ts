// SLA store (Iteration 4) — module-scope reactive list persisted to localStorage.
...
import { ref } from 'vue'
import { SEED_SLAS, type Sla } from '@/data/slaDataV4'
import { channelConflicts } from '@/lib/slaV4'
...
export function useSlaPoliciesV4() {
