...
import { ref } from 'vue'
import { SEED_POLICIES, type Policy } from '@/data/slaDataV2'
import { channelConflicts } from '@/lib/slaV2'

const STORAGE_KEY = 'trengo_sla_policies_v2'
...
// TargetSetting.enabled (per-target on/off toggles). v7: resolution by
// question type — resolution is now { enabled, default, rows[] }. v8:
// resolution scoped by a custom field — added fieldId, rows use optionId.
...
export function useSlaPoliciesV2() {
